...
Files: src/dialogue/engine_state.py (rewritten), engine.py, pivot_fill.py, similar_fit.py, harness.py, CONTEXT.md (STM glossary reverted to general form), docs/behaviour-notes.md (four-store model replaces the false cascade rule).

_Relevance: high_
_Context: Lean harness: correcting the EngineState four-store memory model_
_Tags: engine ltm stm dialogue engine-state refactor_

---

_Observed: 2026-08-11T16:32:17.306Z_
