...
description: The closed set of KScript tokens (==, =>, >, =, none) declaring how a kline is produced and its provenance — COUNTERSIGNS, CANONIZES, CONNOTES, DENOTES, UNKNOWN.
created: 2026-08-11
updated: 2026-08-11
sources:
...
| `=>` | CANONIZES | 1:many `{A:[B,C,D]}` | declares intent to aggregate (need not produce a [[concepts/canon]]) |
...
- [[concepts/canon]] — what CANONIZES intends but need not produce
