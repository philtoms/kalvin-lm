...
description: The closed set of KScript tokens (==, =>, >, =, none) declaring how a kline is produced and its provenance — COUNTERSIGNS, CANONICALISES, CONNOTES, DENOTES, UNKNOWN.
created: 2026-08-11
updated: 2026-08-11
sources:
...
| `=>`  | CANONICALISES | 1:many `{A:[B,C,D]}`                     | declares intent to aggregate (need not produce a [[concepts/canon]]) |
...
- [[concepts/canon]] — what CANONICALISES intends but need not produce
