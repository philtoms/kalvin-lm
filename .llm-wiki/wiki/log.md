...
- **retro**: {"category":"architecture","slug":"kscript-import-shared-emitter-semantics","title":"kscript import: shared-emitter semantics and the ask-never-heads-a-goal fix"}
- **observe**: {"relevance":"critical","slug":"obs-2026-09-23-kscript-import-statement-implemented-shared-emitter-walk","title":"kscript import statement implemented (shared-emitter walk)"}
...
- **observe**: {"relevance":"medium","slug":"obs-2026-08-11-wiki-corrected-for-enginestate-four-store-model","title":"Wiki corrected for EngineState four-store model"}
- **lint**: {"auto_fix":true,"contradictions":0,"legacy_pages_repaired":0,"missing_pages":0,"orphans":6}
- **observe**: {"relevance":"high","slug":"obs-2026-08-11-enginestate-four-store-model-grounded-ltm-stm-disconnected","title":"EngineState four-store model: grounded→ltm, STM disconnected"}
- **retro**: {"category":"backend","slug":"stm-cascade-removals-orphan-check","title":"STM cascade removals must be orphan-checked"}
- **observe**: {"relevance":"high","slug":"obs-2026-08-11-stm-introduced-into-enginestate-as-write-cascade-index","title":"STM introduced into EngineState as write-cascade index"}
- **observe**: {"relevance":"high","slug":"obs-2026-08-11-all-kalvin-wiki-stub-pages-filled-in","title":"All Kalvin wiki stub pages filled in"}
- **retro**: {"category":"wiki-maintenance","slug":"wiki-duplicate-consolidation","title":"Consolidated wiki duplicate concept pages"}
- **ingest**: {"background":true,"concepts_created":14,"contradictions":0,"entities_created":1,"source_id":"SRC-2026-08-11-003"}
- **ingest**: {"background":true,"concepts_created":10,"contradictions":0,"entities_created":13,"source_id":"SRC-2026-08-11-002"}
- **capture**: {"format":"markdown","source_id":"SRC-2026-08-11-003"}
- **capture**: {"format":"markdown","source_id":"SRC-2026-08-11-002"}
- **observe**: {"relevance":"high","slug":"obs-2026-08-11-no-python-m-kscript-entrypoint-exists","title":"No `python -m kscript` entrypoint exists"}
- **observe**: {"relevance":"high","slug":"obs-2026-08-11-readme-md-updated-to-match-actual-source-tree","title":"README.md updated to match actual source tree"}
- **ingest**: {"background":true,"concepts_created":29,"contradictions":0,"entities_created":6,"source_id":"SRC-2026-08-11-001"}
- **capture**: {"format":"markdown","source_id":"SRC-2026-08-11-001"}
- **bootstrap**: {"mode":"personal","topic":"Kalvin — a rationalising system built from klines (structural significance, rational significance, S-levels, dialogue training)"}
