...
description: The training harness runtime — the multi-agent WebSocket server and message bus, plus the lean synchronous dialogue harness. Both drive the K engine.
created: 2026-08-11
updated: 2026-08-11
sources:
...
- **`src/dialogue/harness.py`** — the lean dialogue harness. A minimal,
...
- [SRC-2026-08-11-002](/sources/SRC-2026-08-11-002.md) — the lean harness's non-judging principle
- [[concepts/harness]] — the general concept
- [[concepts/non-judging-harness]] — the lean harness's defining principle
