...
| MOD-52  | `classify_misfit` (see @kline KL-32..34): canonical → (False, False)                                                                                                                                     | —          |
| MOD-53  | `classify_misfit` (see @kline): underfit → (True, False)                                                                                                                                                 | —          |
| MOD-54  | `classify_misfit` (see @kline): overfit → (False, True)                                                                                                                                                  | —          |
| MOD-55  | `classify_misfit` (see @kline): dual → (True, True)                                                                                                                                                      | —          |
