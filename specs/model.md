...
| MOD-53  | `classify_misfit` (see @signifier): underfit → (True, False)                                                                                                                                              | —          |
| MOD-54  | `classify_misfit` (see @signifier): overfit → (False, True)                                                                                                                                               | —          |
| MOD-55  | `classify_misfit` (see @signifier): dual → (True, True)                                                                                                                                                   | —          |
