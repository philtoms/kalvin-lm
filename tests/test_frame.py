...
class TestFrameQuery:
    ...
    def test_single_match(self):
        ...
        query = KLine(signature=0xFF00, nodes=[])
        frame = Frame([non_matching, matching])
    ...
    def test_all_matches_returned(self):
        ...
        query = KLine(signature=0xFF00, nodes=[])
        non_matching = KLine(signature=0x0001, nodes=[])
        frame = Frame([non_matching, match1, match2])
    ...
    def test_reverse_insertion_order(self):
        ...
        query = KLine(signature=0xFF00, nodes=[])
        frame = Frame([match1, match2, match3])

        assert list(frame.query(query)) == [match3, match2, match1]


class TestFrameExpand:
    ...
    def test_depth_expands_children(self):
        ...
        frame = Frame([parent, child1, child2])
    ...
    def test_depth_limits_expansion(self):
        ...
        frame = Frame([parent, child, grandchild])
    ...
    def test_nested_hierarchy_expansion(self):
        ...
        frame = Frame([root, intermediate, leaf1, leaf2, leaf3])
    ...
    def test_cyclic_children_stops_expansion(self):
        ...
        frame = Frame([root, child, grandchild])
    ...
    def test_missing_child_nodes_skipped(self):
        ...
        frame = Frame([parent])  # children not added
...
class TestGetAllDescendants:
    """Tests for Frame.get_all_descendants method."""
    ...
    def test_multiple_branches(self):
        ...
        frame = Frame([root, branch1, branch2, leaf1, leaf2, leaf3])
