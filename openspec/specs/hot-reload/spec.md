...
Hot reload capability for the KScript TUI application in development mode. Enables automatic app restart when source files change, with state preservation across restarts.
