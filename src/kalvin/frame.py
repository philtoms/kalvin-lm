"""Frame - Collection of KLines for knowledge graph operations."""

from typing import Iterator

from kalvin.abstract import KLine, KFrame, KNode, KNone, KNodes, KSig
...
class Frame(KFrame):
    ...
    def __init__(self, klines: list[KLine] | None = None, parent: "KFrame | None" = None):
        self.parent = parent
...
class _KLineAccessor:
    ...
    def __getitem__(self, signature: KSig) -> KLine:
        return self._frame.find_kline(signature)
